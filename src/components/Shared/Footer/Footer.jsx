					...
					<div className="row">
						...
						<div className="col-6 col-md-6 col-lg-3">
							<div className="footer-widget footer-menu">
								...
								<ul>
									<li><Link to={'/'}><FaAngleDoubleRight className='icon' />  Search for Doctors</Link></li>
									<li><Link to={'/'}><FaAngleDoubleRight className='icon' />  Login</Link></li>
									<li><Link to={'/'}><FaAngleDoubleRight className='icon' />  Register</Link></li>
									<li><Link to={'/'}><FaAngleDoubleRight className='icon' />  Booking</Link></li>
						...
						<div className="col-6 col-md-6 col-lg-3">
							...
							<div className="footer-widget footer-menu">
								...
								<ul>
									...
									<li><Link to={'/'}><FaAngleDoubleRight className='icon' /> Login</Link></li>
									<li><Link to={'/'}><FaAngleDoubleRight className='icon' /> Register</Link></li>
									<li><Link to={'/'}><FaAngleDoubleRight className='icon' /> Doctor Dashboard</Link></li>
								</ul>
							</div>
						</div>
